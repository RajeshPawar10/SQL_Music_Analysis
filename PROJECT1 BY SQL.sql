...
WITH best_selling_artist AS (
    ...
    JOIN album2 ON album2.album_id = track.album_id
    JOIN artist ON artist.artist_id = album2.artist_id
    GROUP BY artist.artist_id, artist.name   -- ✅ fixed
    ORDER BY total_sales DESC                -- ✅ named column
    LIMIT 1
)
SELECT 
    c.customer_id, 
...
GROUP BY c.customer_id, c.first_name, c.last_name, bsa.artist_name  -- ✅ fixed
...
ORDER BY sales_per_country.country ASC;
